...
var Post = function Post() {
  ...
  var getSelection = function getSelection(e) {
    ...
    if (text !== "" && selectedText !== "") {
      ...
      console.log(text.indexOf(selectedText)); //   let regexText = new RegExp(selectedText, g);

      var strMatch = text.matchAll(selectedText);
...
//# sourceMappingURL=post.js.0702b6a1bca775be29e5.hot-update.js.map